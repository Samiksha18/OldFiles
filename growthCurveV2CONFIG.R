...
library(dplyr)
#################   Experiment title        #####################
experiment_title<-"rsaD_codYrsaD_dualRead"
experiment_date<-"20150814"
...
####  Input from Excel
excel_data<- loadWorkbook("../../Lab_data/Maggie/ON730_731_337.xlsx")
...
normMethod<-"col"# "rawMean" ,"none", "row", or "col"
mediaMin<-0.05
media<-"TSB"
