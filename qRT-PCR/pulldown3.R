...
inp_dna_concentration<-1*10^8

###########revamp dilution notation 
#  define input genomic dna concentration (copies per ul), and dilution series used
A<-inp_dna_concentration/1
B<-inp_dna_concentration/10
C<-inp_dna_concentration/100
D<-inp_dna_concentration/1000
E<-inp_dna_concentration/10000
F<-inp_dna_concentration/100000
G<-inp_dna_concentration/1000000
H<-inp_dna_concentration/10000000
...
wk1t$condition<-cqdfSamp$Sample ####
...
try(wk2t$condition<-cqdfSamp2$Sample, silent=T) 
