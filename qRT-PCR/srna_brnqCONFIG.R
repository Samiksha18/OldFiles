...
#################   Experiment title        #####################
experiment_title<-"sRNA_brnq_ColdShock"  #@@@@@@@@@@@@@@@@@@@@@@@@@@
experiment_date<-"20150422"               #@@@@@@@@@@@@@@@@@@@@@@@@@@

title<-paste(experiment_date, "_",experiment_title, sep="")

#################   Input and Output Directories        #####################

inputDirStd<-"../../Lab_data/RT_PCR/brnqstd/"   #@@@@@@@@@@@@@@@@@@@@@@@@@@
inputDirSamp<-"../../Lab_data/RT_PCR/brnq/"   #@@@@@@@@@@@@@@@@@@@@@@@@@@
#inputDirSamp2<-"../../Lab_data/RT_PCR/brnq/"   #@@@@@@@@@@@@@@@@@@@@@@@@@@
